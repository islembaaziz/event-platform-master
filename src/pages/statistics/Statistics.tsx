...
const Statistics = () => {
  ...
  const fetchEvents = async () => {
    try {
      ...
      setEvents(data.map((event: any) => ({ _id: event._id, title: event.title })));
    } catch (error) {
  ...
  const contentDistributionData = {
    labels: ['Events', 'Images', 'Videos', 'Publications'],
    datasets: [
      {
        ...
        data: [
          ...
          statisticsData.contentDistribution.videos,
  ...
  const topEventsData = {
    labels: statisticsData.topPerforming.events.slice(0, 5).map(event => event.title.substring(0, 20) + '...'),
    datasets: [
      {
        label: 'Engagement Score',
        data: statisticsData.topPerforming.events.slice(0, 5).map(event => event.engagementScore),
      ...
      <div className="space-y-6">
        ...
        <div className="bg-dark-100 p-4 rounded-lg">
          <div className="flex flex-wrap gap-4 items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-lg font-semibold text-white">Event Analytics</h2>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="stat-card">
            ...
            <div className="stat-value">{statisticsData.summary.totalLikes.toLocaleString()}</div>
          </div>
          ...
          <div className="stat-card">
            ...
            <div className="stat-value">{statisticsData.summary.totalComments.toLocaleString()}</div>
          </div>
          ...
          <div className="stat-card">
            ...
            <div className="stat-value">{statisticsData.userActivity.activeUsers.toLocaleString()}</div>
          </div>
          ...
          <div className="stat-card">
            ...
            <div className="stat-value">{statisticsData.userActivity.newUsers.toLocaleString()}</div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-dark-100 rounded-lg overflow-hidden">
            ...
            <div className="p-4" style={{ height: '300px' }}>
              <Doughnut data={contentDistributionData} options={doughnutChartOptions} />
            </div>
          </div>
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full divide-y divide-dark-300">
                <thead className="bg-dark-200">
                  <tr>
                    <th className="px-4 py-3 text-left text-xs font-medium text-dark-500 uppercase">Event</th>
                    <th className="px-4 py-3 text-left text-xs font-medium text-dark-500 uppercase">Likes</th>
                    <th className="px-4 py-3 text-left text-xs font-medium text-dark-500 uppercase">Comments</th>
                    <th className="px-4 py-3 text-left text-xs font-medium text-dark-500 uppercase">Views</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-dark-300">
                  {statisticsData.topPerforming.events.slice(0, 5).map((event, index) => (
                    <tr key={event._id} className="hover:bg-dark-200">
                      ...
                      <td className="px-4 py-3 text-sm text-white">{event.likesCount}</td>
                      <td className="px-4 py-3 text-sm text-white">{event.commentsCount}</td>
                      <td className="px-4 py-3 text-sm text-white">{event.views}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
          ...
          <div className="bg-dark-100 rounded-lg overflow-hidden">
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full divide-y divide-dark-300">
                <thead className="bg-dark-200">
                  <tr>
                    <th className="px-4 py-3 text-left text-xs font-medium text-dark-500 uppercase">Media</th>
                ...
                <tbody className="divide-y divide-dark-300">
                  {statisticsData.topPerforming.media.slice(0, 5).map((media, index) => (
                    <tr key={media._id} className="hover:bg-dark-200">
                      ...
                      <td className="px-4 py-3 text-sm text-white capitalize">{media.type}</td>
                      <td className="px-4 py-3 text-sm text-white">{media.likesCount}</td>
                      <td className="px-4 py-3 text-sm text-white">{media.commentsCount}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
