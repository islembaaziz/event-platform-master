...
interface User {
  ...
  name: string;
  email: string;
  role: "admin" | "organizer" | "participant" | "administrator";
  organization?: string;
  bio?: string;
  website?: string;
  created_at: string;
                        ...
                        >
                          <td className="p-3">
                            <input
                              ...
                              onChange={() =>
                                toggleUserSelection(String(user._id))
                              }
                              className="rounded"
                            />
                          </td>
                            ...
                            <div className="relative group">
                              ...
                              {user._id !== currentUser?._id && (
                                <div className="absolute left-0 top-full mt-1 bg-dark-100 rounded-md shadow-lg z-10 w-40 py-1 border border-dark-300 hidden group-hover:block">
                                  <button
                                    onClick={() =>
                                      updateUserRole(user._id, "participant")
                                    }
                                  ...
                                  <button
                                    onClick={() =>
                                      updateUserRole(user._id, "administrator")
                                    }
                                    className="block w-full text-left px-3 py-1 text-sm text-dark-600 hover:bg-dark-200 hover:text-white"
                                  >
                                    Administrator
